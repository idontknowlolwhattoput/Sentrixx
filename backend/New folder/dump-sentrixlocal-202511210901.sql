...
INSERT INTO `employee_account` VALUES (1,'Pediatrician','daryl iveen-cogal-bisaya','$2b$10$Ankjnq5AhtZHHN/HiXq7leCoDP8MS5WHrWTCOjQOuDicSqCPYNJgy','2025-11-07 05:55:38','2025-11-21 08:38:22'),(2,'Cardiologist','sdf-sdf-sdf','$2b$10$aOqCqSlqwdwhEFxgaqRfruOUlpy1Som9FhXMddUx.qdqtdATGPYsm','2025-11-07 20:51:12','2025-11-21 08:38:22'),(3,'admin','admin-admin-admin','$2b$10$8qAdrdiY4i73yNd1F9XMeebK0RF4ZW1zlKa8YemmyaPKVv3jPI3IO','2025-11-21 08:07:35','2025-11-21 08:07:35');
...
INSERT INTO `employee_info` VALUES (1,NULL,'Cogal','Bisaya','Daryl iveen','valdez_johnpaul@plpasig.edu.ph','Male','5345345','3453453'),(2,NULL,'sdf','sdf','sdf','vergara_joshuamiguel@plpasig.edu.ph','Male','4234','234'),(3,NULL,'admin','admin','admin','migzkrak@gmail.com','Male','123','123');
...
CREATE TABLE `patient_visit_record` (
  ...
  `visit_type` enum('Inpatient','Outpatient','Emergency') NOT NULL,
  `visit_status` enum('In-progress','Completed','Cancelled') NOT NULL,
...
-- Dump completed on 2025-11-21  9:01:00
