...
INSERT INTO `employee_account` VALUES (1,'Manager','johndoe','hashed_password_123','2025-11-05 00:34:14','2025-11-05 00:34:14'),(2,'Manager','joh2ndoe','hashed_password_123','2025-11-05 00:34:21','2025-11-05 00:34:21');
...
INSERT INTO `employee_info` VALUES (1,NULL,'John','Michael','Doe','john.doe@company.com','Male'),(2,NULL,'John','Michael','Doe','jo2hn.doe@company.com','Male');
...
BEGIN
    ...
    -- Insert into employee_accounts FIRST (due to FK constraint)
    ...
    -- Insert into employee_info SECOND
    INSERT INTO employee_info (employee_id, first_name, middle_name, last_name, email, sex)
    VALUES (new_employee_id, p_first_name, p_middle_name, p_last_name, p_email, p_sex);
    ...
    -- Return success with new employee_id
    SELECT 
...
-- Dump completed on 2025-11-05 12:19:38
